...
# Conan 2D20 Dice
Conan_Dmg = SymbolDice([["Hit"], ["Hit", "Hit"], ["Blank"], ["Hit", "Effect"]],
                       [1, 1, 2, 2], "Conan_Dmg")

# Genesys
Boost = SymbolDice([["Blank"], ["Success"], ["Success", "Advantage"],
                    ["Advantage", "Advantage"], ["Advantage"]], [2, 1, 1, 1, 1], "Boost")
Setback = SymbolDice([["Blank"], ["Failure"], ["Threat"]], [2, 2, 2], "Setback") #[1,1,1] works the same                                                   
Ability = SymbolDice([["Blank"], ["Success"], ["Success", "Success"], ["Advantage"],
